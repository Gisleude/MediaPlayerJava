 ...
 * @author gisleude
 */
public class RemoveMusicaUserVIPAdmin extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveMusicaUserVIPAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveMusicaUserVIPAdmin().setVisible(true);
            }
        });
    }
